...
import { mergeDefaultProps } from "../props";
...
> = ButtonRootOptions & Partial<ButtonRootCommonProps<ElementOf<T>>> & { variant?: Variant };
 ...
 */
export type Props<T extends ValidComponent = "button"> = PolymorphicProps<T, ButtonRootProps<T>>;

export function ButtonRoot<T extends ValidComponent = "button">(props: Props<T>) {
  ...
  const variant = createMemo(() => Variants[local.variant || "primary"] || Variants["primary"]);
